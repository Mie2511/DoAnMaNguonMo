...
?>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 mt-3 bg-info p-4 rounded">
        <h2 class="bg-light p-2 rounded text-center text-dark">ID : <?= $vidBG; ?></h2>
        <div class="text-center">
          <img src="<?= $vphotoBG; ?>" width="300" class="img-thumbnail">
        </div>
        <h4 class="text-light">Tên: <?= $vtenBG; ?></h4>
        <h4 class="text-light">Thông tin : <?= $vthongtinBG; ?></h4>
        <h4 class="text-light">Giá tiền : <?= $vgiatienBG; ?></h4>
      </div>
    </div>
  </div>
</body>
