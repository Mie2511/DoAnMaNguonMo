  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <form action="burger.php" method="post" enctype="multipart/form-data">
          <input type="hidden" name="idBG" value="<?= $idBG; ?>">
          <div class="form-group">
            <input type="text" name="tenBG" value="<?= $tenBG; ?>" class="form-control" placeholder="Tên loại burger" required>
          </div>
          <div class="form-group">
            <input type="thongtinBG" name="thongtinBG" value="<?= $thongtinBG; ?>" class="form-control" placeholder="Mô tả" required>
          </div>
          <div class="form-group">
            <input type="tel" name="giatienBG" value="<?= $giatienBG; ?>" class="form-control" placeholder="Giá tiền" required>
          </div>
          <div class="form-group">
            <input type="hidden" name="oldimage" value="<?= $photoBG; ?>">
            <input type="file" name="image" class="custom-file">
            <img src="<?= $photoBG; ?>" width="120" class="img-thumbnail">
          </div>
          <div class="form-group">
            <?php if ($update == true) { ?>
      ...
      <div class="col-md-8">
        ...
        <table class="table table-hover" id="data-table">
          <thead>
            <tr>
              <th>Id</th>
              <th>Ảnh bánh Burger</th>
              <th>Tên loại Burger</th>
              <th>Thông tin</th>
              <th>Giá tiền</th>
              <th>Chức năng</th>
            </tr>
          ...
          <tbody>
            ...
            <tr>
              <td><?= $row['idBG']; ?></td>
              <td><img src="<?= $row['photoBG']; ?>" width="25"></td>
              <td><?= $row['tenBG']; ?></td>
              <td><?= $row['thongtinBG']; ?></td>
              <td><?= $row['giatienBG']; ?></td>
              <td>
                <a href="details-BG.php?details=<?= $row['idBG']; ?>" class="badge badge-primary p-2">Thông tin</a> |
                <a href="burger.php?delete=<?= $row['idBG']; ?>" class="badge badge-danger p-2" onclick="return confirm('Bạn có muốn xóa cái này?');">Xóa</a> |
                <a href="quanly-burger.php?edit=<?= $row['idBG']; ?>" class="badge badge-success p-2">Sửa</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
