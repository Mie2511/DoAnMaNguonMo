    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:burlywood; font-size: small; ">
            ...
            <a class="dropdown-item" href="index-mi.php">Mì Ý</a>
              ...
              <li class="nav-item active"><a href="giohang.php" class="nav-link">Giỏ hàng</a></li>
              <?php
...
// Câu truy vấn SQL để lấy thông tin giỏ hàng
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<p class="item-info">' . $row['tenmon'] . ' - Số lượng: ' . $row['soluong'] . ' - Giá tiền: ' . $row['giatien'] . '</p>';
        echo '</div>';
    }
} else {
    echo '<p class="empty-cart">Rất tiếc!!! Bạn không có sản phẩm trong giỏ hàng.</p>';
}

?>
</section>
<a href="thanhtoan.php"><button name="button" type="button" onclick="hello()">Thanh toán</button>  </a>
