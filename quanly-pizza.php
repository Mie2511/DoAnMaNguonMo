...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-4">
        <h3 class="text-center text-info">Thêm pizza</h3>
        <form action="pizza.php" method="post" enctype="multipart/form-data">
          <input type="hidden" name="id" value="<?= $id; ?>">
          <div class="form-group">
            <input type="text" name="ten" value="<?= $ten; ?>" class="form-control" placeholder="Tên Pizza" required>
          </div>
          <div class="form-group">
            <input type="thongtin" name="thongtin" value="<?= $thongtin; ?>" class="form-control" placeholder="Thông Tin Pizza" required>
          </div>
          <div class="form-group">
            <input type="tel" name="size" value="<?= $size; ?>" class="form-control" placeholder="Size" required>
          </div>
          <div class="form-group">
            <input type="tel" name="giatien" value="<?= $size; ?>" class="form-control" placeholder="Giá tiền" required>
          </div>
          <div class="form-group">
      ...
      <div class="col-md-8">
        ...
        ?>
        <h3 class="text-center text-info">Pizza</h3>
        <table class="table table-hover" id="data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= $row['giatien']; ?></td>
              <td>
                <a href="details-pizza.php?details=<?= $row['id']; ?>" class="badge badge-primary p-2">Thông tin</a> |
                <a href="pizza.php?delete=<?= $row['id']; ?>" class="badge badge-danger p-2" onclick="return confirm('Bạn có muốn xóa cái này?');">Xóa</a> |
                <a href="quanly-pizza.php?edit=<?= $row['id']; ?>" class="badge badge-success p-2">Sửa</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
