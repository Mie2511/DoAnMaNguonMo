...
<form action="" method="post">
    <table align="center" bgcolor="#33FFCC">
        <tr>
            <td colspan="2" bgcolor="#33CCCC"><h1>THANH TOÁN TIỀN ĐIỆN</h1></td>
        </tr>
        <tr>
            <td>Tên chủ hộ: </td>
        ...
        <tr>
            ...
            <td> <input type="text" name="tientt" style="background-color: #33CC99" readonly
