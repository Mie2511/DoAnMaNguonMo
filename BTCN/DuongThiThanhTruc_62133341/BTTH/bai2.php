...
<form action="" method="post">
    <table align="center" bgcolor="pink">
        <tr>
            <td colspan="2" bgcolor="yellow"><h1>DIỆN TÍCH CHU VI HÌNH TRÒN</h1></td>
        </tr>
        <tr>
            <td>Bán Kính: </td>
        ...
        <tr>
            <td>Diện tích: </td>
            <td> <input type="text" name="area" style="background-color: bisque; width: 150px" readonly
                        value="<?php if (isset($s)) echo $s; else echo "";?>">
            </td>
        </tr>
        <tr>
            <td>Chu vi: </td>
            <td> <input type="text" name="chuvi" style="background-color: bisque; width: 150px" readonly
