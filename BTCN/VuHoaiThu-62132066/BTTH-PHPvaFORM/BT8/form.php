            ...
            <div class="">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="sub1" value="PHP & MySQL">PHP & MySQL </input>
                            <input type="checkbox" name="sub2" value="C#">C# </input>
                            <input type="checkbox" name="sub3" value="XML">XML </input>
                            <input type="checkbox" name="sub4" value="Python">Python </input>
                        </td>
                    </tr>
                    <tr>
