      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <h2 class="mb-3"> American Pizza </h2>
            <p>Với sự kết hợp tuyệt vời giữa hương vị truyền thống và đa dạng, American Pizza mang đến cho bạn một trải nghiệm ẩm thực một cách chân thực. Hãy cùng khám phá và thưởng thức hương vị Pizza American tuyệt vời này!</p>
            <p>
              <img src="images/image_1.jpg" alt="" class="img-fluid">
            </p>
            <p>American Pizza không chỉ đơn thuần là một món ăn nhanh, mà còn là một biểu tượng của ẩm thực Mỹ. Từ những loại pizza truyền thống như Pepperoni, BBQ Chicken, Meat Lover, đến những phiên bản đặc biệt như Buffalo Chicken hoặc Philly Cheesesteak, mỗi miếng pizza đều mang trong đó một hương vị độc đáo và thú vị.</p>
            </p>
            <h2 class="mb-3 mt-5"></h2>
            <p>Con Rồng Cháu Tiên muốn làm cho trải nghiệm thưởng thức American Pizza của bạn trở nên thêm phần đặc biệt và sinh động. Vì vậy, chúng tôi mang đến một ưu đãi hấp dẫn - giảm giá 20% trên tổng hóa đơn mỗi dịp Giáng Sinh. Đây là cơ hội tuyệt vời hiếm có để bạn thưởng thức hương vị Mỹ đặc trưng và cùng gia đình và bạn bè tận hưởng một bữa tiệc pizza đầy ấm cúng và vui vẻ mà không cần lo lắng về giá cả.</p>
            <p>
              <img src="images/image_2.jpg" alt="" class="img-fluid">
            </p>
            <p>Đừng lo lắng về việc lấy hàng! Chúng tôi cung cấp dịch vụ giao hàng nhanh chóng và tiện lợi, đảm bảo rằng mỗi miếng pizza Amercian sẽ được đưa đến tận cửa nhà bạn. Bạn chỉ cần ngồi thoải mái, thưởng thức và tận hưởng hương vị độc đáo mà chúng tôi mang đến.</p>
